<nav class="bg-[#162029] text-white w-64 h-screen fixed top-0 left-0 flex overflow-y-auto flex-col p-6">
        <h1 class="text-3xl font-bold text-[#e5d283] mb- text-center p-5 mb-10">UNITYGRID</h1> 
        <ul class="flex flex-col space-y-4 w-full">
            ...
            <div class="mt-auto w-full">
                <a href="/Utility-Management-System/logout.php" class="block text-center text-[#162029] font-bold p-3 mt-6 bg-[#e5d283] hover:bg-[#e43e4a] rounded  w-full transition">Log out</a>
            </div>
