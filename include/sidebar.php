<nav class="bg-[#213655] text-white w-64 h-screen fixed top-0 left-0 flex overflow-y-auto flex-col p-6">
        ...
        <ul class="flex flex-col space-y-4 w-full">
            ...
            <div class="mt-auto w-full">
                <a href="/Utility-Management-System/logout.php" class="block text-center text-[#162029] p-3 mt-6 bg-[#e5d283] hover:bg-red-500 rounded font-semibold w-full transition">Log out</a>
            </div>
