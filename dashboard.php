...
<main class="flex-1 p-8 overflow-y-auto min-h-screen ml-64 bg-gradient-to-br from-[#213655] to-[#e5d283]">
   ...
   <div class="flex mt-10 gap-10 flex-1">
        ...
        <div class="flex flex-col gap-6">
            ...
            <button class="bg-[#213655] text-white font-semibold py-4 px-6 rounded shadow hover:bg-[#162029] transition"><a href="Tariff1.php" class="block w-full h-full">Add new tariff plan</button>
            ...
            <button class="bg-[#213655] text-white font-semibold py-4 px-6 rounded shadow hover:bg-[#162029] transition">Add new connection</button>
        </div>
   </div>
</main>
 </div>
